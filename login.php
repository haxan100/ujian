...
if(isset($_POST["login"])){
	...
	$datas=mysqli_query($data,"SELECT * FROM siswa WHERE nisn='".mysqli_real_escape_string($data,$_2d76471e6f56a63e6f0105dd92db4254)."' AND password='".$_243e61e9410a9f577d2d662c67025ee9."'");
	if(mysqli_num_rows($datas)>0){
		$_60169cd1c47b7a7a85ab44f884635e41=mysqli_fetch_array($datas);

...
if(isset($_POST['jawab'])){
	...
	exit("<script>location.href='ujian.php?no=".($_POST['no']+1)."';</script>");
}
...
<div class="row">
	<div class="col-lg-12">
		...
		<span id="timer"><span class="label label-success">Siswa Waktu : <?php echo gmdate("H:i:s", ($waktu-$_02202b271eddd150fb9b3a5c12a8639d));?></span></span>
...
<div class="btn-group" role="group" aria-label="...">
  ...
  <?php
  if($_b44cb2e694287fa912cc50de8b3a920b==count($paket)){$_849d693c62dfe15394a642123c1599c8='disable';$_1261cd629575acc614af0867c1e29e37='#';}else{$_849d693c62dfe15394a642123c1599c8='';$_1261cd629575acc614af0867c1e29e37='ujian.php?no='.($_b44cb2e694287fa912cc50de8b3a920b+1);}
  ?>

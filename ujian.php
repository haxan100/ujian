...
<div class="btn-group" role="group" aria-label="...">
  <?php
  if($awalansims==1){$optidis='enable';$propper='#';}else{$optidis='';$propper='ujian.php?no='.($awalansims-1);}
  ?>
  <a href="<?php echo $propper;?>" class=" <?php echo $optidis;?>"></i></a>
  ...
  <?php
  if($awalansims==count($paket)){$optidis='disable';$propper='#';}else{$optidis='';$propper='ujian.php?no='.($awalansims+1);}
  ?>
  <a href="<?php echo $propper;?>" class=" <?php echo $optidis;?>"></a>
...
for($mulai=0;$mulai<count($paket);$mulai++){
	...
	if($paket[$mulai][1]!=''){
		echo '<a href="#" class="btn btn-info btn-sm '.$botton.'" style="margin-bottom:5px;">'.$awal.' <i class="fa fa-check"></i></a> ';
	}else{
		echo '<a href="#" class="btn btn-default btn-sm '.$botton.'" style="margin-bottom:5px;">'.$awal.'</a> ';
	}
}
?>
</center>
...
---------------------------------------------
haxan100
soal sebelumnya=<?php echo $propper;?>
ujian.php?no='.$awal.'
ujian.php?no='.$awal.'
*/
?>

...
if(isset($_GET['paket'])){
	...
	$_eb6af5b4e510c3c874d7d1f51d72393a=mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"select id_soal from soal_paket where id_paket='".$_b78f9e7c4587e8583ab713f126277f88."'");

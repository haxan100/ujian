...
if(mysqli_num_rows($_eb6af5b4e510c3c874d7d1f51d72393a) > 0){
	while($_60169cd1c47b7a7a85ab44f884635e41=mysqli_fetch_array($_eb6af5b4e510c3c874d7d1f51d72393a)){
		...
		if(mysqli_num_rows(mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"select id_soal_paket from soal_paket where id_paket='".$_b78f9e7c4587e8583ab713f126277f88."' and id_soal='".$_3584859062ea9ecfb39b93bfcef8e869."'")) > 0){
			$_d4cb19f81c23886f544f26709bd4f799.='
			  <tr>

...
$conn=mysqli_query($conns,"select count(*) as jml from kelas where (kode like '%".$sqlgetsoal."%' or nama like '%".$sqlgetsoal."%')");
...
$tables='';
$conn="select * from kelas where (kode like '%".$sqlgetsoal."%' or nama like '%".$sqlgetsoal."%') order by nama limit ".$nilaiujiansoals.",".$nilaiujiansoal;

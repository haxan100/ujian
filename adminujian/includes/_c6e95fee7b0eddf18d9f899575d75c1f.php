...
$_eb6af5b4e510c3c874d7d1f51d72393a=mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"select count(*) as jml from siswa where id_kelas='".$_72e838785b161ce1f713d6b1a452e270."' and (nisn like '%".$_36923cf62618d1b9981740738971e651."%' or nama like '%".$_36923cf62618d1b9981740738971e651."%')");
...
$hasil='';
$_eb6af5b4e510c3c874d7d1f51d72393a="select * from siswa where id_kelas='".$_72e838785b161ce1f713d6b1a452e270."' and (nisn like '%".$_36923cf62618d1b9981740738971e651."%' or nama like '%".$_36923cf62618d1b9981740738971e651."%') order by nisn limit ".$_4e4149dcf4b3b60bf0aaf69dd2348c4d.",".$_111f1b5b84b5c819ea9ae35968fce466;
...
if(mysqli_num_rows($_eb6af5b4e510c3c874d7d1f51d72393a) > 0){
	while($_60169cd1c47b7a7a85ab44f884635e41=mysqli_fetch_array($_eb6af5b4e510c3c874d7d1f51d72393a)){
		...
		if(mysqli_num_rows(mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"select id_peserta from peserta where id_paket='".$_b78f9e7c4587e8583ab713f126277f88."' and id_siswa='".$_3584859062ea9ecfb39b93bfcef8e869."'")) > 0){
			$hasil.='
			  <tr>

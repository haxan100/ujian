...
$_eb6af5b4e510c3c874d7d1f51d72393a=mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"select count(*) as jml from pelajaran where (kode like '%".$_36923cf62618d1b9981740738971e651."%' or nama like '%".$_36923cf62618d1b9981740738971e651."%') ");
...
$_eb6af5b4e510c3c874d7d1f51d72393a="select * from pelajaran where (kode like '%".$_36923cf62618d1b9981740738971e651."%' or nama like '%".$_36923cf62618d1b9981740738971e651."%') order by nama limit ".$_4e4149dcf4b3b60bf0aaf69dd2348c4d.",".$_111f1b5b84b5c819ea9ae35968fce466;
...
if(mysqli_num_rows($_eb6af5b4e510c3c874d7d1f51d72393a) > 0){
	while($_60169cd1c47b7a7a85ab44f884635e41=mysqli_fetch_array($_eb6af5b4e510c3c874d7d1f51d72393a)){
		...
		$_3584859062ea9ecfb39b93bfcef8e869=$_60169cd1c47b7a7a85ab44f884635e41['id_pelajaran'];
...
<div class="row">
	...
	<div class="col-lg-12">
		<h1 class="page-header">DATA PELAJARAN</h1>
	</div>
</div>
<div class="row">
	<div class="col-lg-12">
...
<input name="hal" type="hidden" value="pelajaran" />
...
<a href="<?php echo $_4bf2fdb3ab37a41b537e7360f7e4b007;?>" class="btn btn-primary" style="float:right"><i class="fa fa-plus"></i> Input Pelajaran Baru</a>

...
if(isset($_POST['save'])){
	...
	if(empty($_21eff29b583aa9be1b965eb96e6c56ed)){
		...
		if(mysqli_num_rows(mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"select * from konten where kode='informasi'"))==0){
			$_eb6af5b4e510c3c874d7d1f51d72393a="insert into konten(kode, detail) values('informasi','".$_21eff29b583aa9be1b965eb96e6c56ed."')";
			mysqli_query($_000b935637cea64cc7810fb0077f5ff1,$_eb6af5b4e510c3c874d7d1f51d72393a);
		}else{
			$_eb6af5b4e510c3c874d7d1f51d72393a="update konten set detail='".$_21eff29b583aa9be1b965eb96e6c56ed."' where kode='informasi'";
			mysqli_query($_000b935637cea64cc7810fb0077f5ff1,$_eb6af5b4e510c3c874d7d1f51d72393a);
		}

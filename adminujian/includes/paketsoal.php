...
if(($nilaiujiansoals+1)>1){
	$optionlink='<a href="'.$linkspaketsoal.'&page='.$nilaiujiansoals.'" class="btn btn-primary btn_page" data-param="paket='.$id.'&pelajaran='.$mapel.'&q='.$sqlgetsoal.'&page='.$nilaiujiansoals.'" style="float:left;margin-right:5px;">&laquo; Prev</a>';
}
$optionpaketsoal='';
if(($nilaiujiansoals+1)<$listing){
	$optionpaketsoal='<a href="'.$linkspaketsoal.'&page='.($nilaiujiansoals+2).'" class="btn btn-primary btn_page" data-param="paket='.$id.'&pelajaran='.$mapel.'&q='.$sqlgetsoal.'&page='.($nilaiujiansoals+2).'" style=""> Next &raquo;</a>';
}

...
if(isset($_POST['save'])){
	...
	if($_FILES['csv']['error']==0) {	
		...
		mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"truncate table soal_tmp");
		...
		$_eb6af5b4e510c3c874d7d1f51d72393a=mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"select * from soal_tmp where nisn<>''");

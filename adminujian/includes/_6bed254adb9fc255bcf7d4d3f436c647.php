...
$conn=mysqli_query($conns,"select jumlah from periode_kuota where id_periode='".$id_periode."' and id_jurusan='".$_0a22a15d3692a4e52aea2b257e6a358d."'");
...
$conn=mysqli_query($conns,"select id_siswa from siswa where id_periode='".$id_periode."' and id_jurusan='".$_0a22a15d3692a4e52aea2b257e6a358d."' and status='Y' order by nilai_tes desc,id_siswa");
...
$conn=mysqli_query($conns,"select count(*) as jml from siswa where id_periode='".$id_periode."' and id_jurusan='".$_0a22a15d3692a4e52aea2b257e6a358d."' and status='Y' and (nisn like '%".$_36923cf62618d1b9981740738971e651."%' or nama like '%".$_36923cf62618d1b9981740738971e651."%') ");
$sql=mysqli_fetch_array($conn);
$_12ef5f8660c2350214ce228aad66392d=$sql['jml'];


$_bd374a8757e4ad5e55de663a02a9adde=$pengumuman1.'&periode='.$id_periode.'&q='.$_36923cf62618d1b9981740738971e651.'&jurusan='.$_0a22a15d3692a4e52aea2b257e6a358d;
...
$conn="select * from siswa where id_periode='".$id_periode."' and id_jurusan='".$_0a22a15d3692a4e52aea2b257e6a358d."' and status='Y' and (nisn like '%".$_36923cf62618d1b9981740738971e651."%' or nama like '%".$_36923cf62618d1b9981740738971e651."%') order by nilai_tes desc,nisn limit ".$_4e4149dcf4b3b60bf0aaf69dd2348c4d.",".$_111f1b5b84b5c819ea9ae35968fce466;
...
<a href="export_tes.php?periode=<?php echo $id_periode;?>&amp;jurusan=<?php echo $_0a22a15d3692a4e52aea2b257e6a358d;?>" class="btn btn-primary <?php if($id_periode=='' or $_0a22a15d3692a4e52aea2b257e6a358d==''){echo 'disabled';}?>"><i class="fa fa-save"></i> Download</a>&nbsp;
<a href="print_tes.php?periode=<?php echo $id_periode;?>&amp;jurusan=<?php echo $_0a22a15d3692a4e52aea2b257e6a358d;?>" class="btn btn-primary <?php if($id_periode=='' or $_0a22a15d3692a4e52aea2b257e6a358d==''){echo 'disabled';}?>" target="_blank"><i class="fa fa-print"></i> Cetak</a>

...
if(isset($_POST['save'])){
	...
	if(empty($_31985b26056f955fec6db8f46f87653f) or empty($_36fd7f7111215a7056422e47518363d7)){
		...
		if($_d35a39212fd75e833aea38f90831b2cb=='add'){
			$_eb6af5b4e510c3c874d7d1f51d72393a="insert into paket(nama,waktu_pengerjaan) values('".$_31985b26056f955fec6db8f46f87653f."','".$_36fd7f7111215a7056422e47518363d7."')";
		...
		if($_d35a39212fd75e833aea38f90831b2cb=='edit'){
			$_eb6af5b4e510c3c874d7d1f51d72393a="update paket set nama='".$_31985b26056f955fec6db8f46f87653f."',waktu_pengerjaan='".$_36fd7f7111215a7056422e47518363d7."' where id_paket='".$_3584859062ea9ecfb39b93bfcef8e869."'";
			mysqli_query($_000b935637cea64cc7810fb0077f5ff1,$_eb6af5b4e510c3c874d7d1f51d72393a);
			exit("<script>location.href='".$pengumuman1."';</script>");
		}
	...
	if($_d35a39212fd75e833aea38f90831b2cb=='edit'){
		...
		$_eb6af5b4e510c3c874d7d1f51d72393a=mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"select * from paket where id_paket='".$_3584859062ea9ecfb39b93bfcef8e869."'");
	...
	if($_d35a39212fd75e833aea38f90831b2cb=='delete'){
		$_3584859062ea9ecfb39b93bfcef8e869=$_GET['id'];
		mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"delete from paket where id_paket='".$_3584859062ea9ecfb39b93bfcef8e869."'");
		exit("<script>location.href='".$pengumuman1."';</script>");
	}
	/*if($_d35a39212fd75e833aea38f90831b2cb=='aktif'){
		$_3584859062ea9ecfb39b93bfcef8e869=$_GET['id'];
		mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"update paket set aktif='Y' where id_paket='".$_3584859062ea9ecfb39b93bfcef8e869."'");
		mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"update paket set aktif='N' where id_paket<>'".$_3584859062ea9ecfb39b93bfcef8e869."'");
		exit("<script>location.href='".$pengumuman1."';</script>");
	}*/
}

...
if(isset($_POST['save'])){
	if($_FILES['csv']['error']==0) {	
		...
		mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"truncate table siswa_tmp");
		
		$_eb6af5b4e510c3c874d7d1f51d72393a="
		LOAD DATA LOCAL 
		...
		$_eb6af5b4e510c3c874d7d1f51d72393a=mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"select * from siswa_tmp where nisn<>''");
		while($_60169cd1c47b7a7a85ab44f884635e41=mysqli_fetch_array($_eb6af5b4e510c3c874d7d1f51d72393a)){
			...
			$_7da43659dfebcaab2ad4bbd2f2a98f30=mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"select id_kelas from kelas where kode='".$_38895153c69c18db0dbba317a1d8d369."'");
			...
			mysqli_query($_000b935637cea64cc7810fb0077f5ff1,$_7da43659dfebcaab2ad4bbd2f2a98f30);
		}
		mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"truncate table siswa_tmp");

...
if(isset($_GET['action'])){
	if($_GET['action']=='hapus_ujian'){
		...
		$_eb6af5b4e510c3c874d7d1f51d72393a=mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"select id_paket from ujian where id_ujian='".$_fbd326c813664d903c80679981cafba3."'");
		...
		mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"delete from ujian where id_ujian='".$_fbd326c813664d903c80679981cafba3."'");
		mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"delete from ujian_detail where id_ujian='".$_fbd326c813664d903c80679981cafba3."'");
...
if(mysqli_num_rows($_eb6af5b4e510c3c874d7d1f51d72393a) > 0){
	while($_60169cd1c47b7a7a85ab44f884635e41=mysqli_fetch_array($_eb6af5b4e510c3c874d7d1f51d72393a)){
		...
		$_7da43659dfebcaab2ad4bbd2f2a98f30=mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"select * from ujian where id_paket='".$_b78f9e7c4587e8583ab713f126277f88."' and id_siswa='".$_60169cd1c47b7a7a85ab44f884635e41['id_siswa']."' and selesai='Y'");

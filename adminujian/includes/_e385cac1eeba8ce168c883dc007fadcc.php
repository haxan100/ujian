...
if(mysqli_num_rows($conn) > 0){
	while($_60169cd1c47b7a7a85ab44f884635e41=mysqli_fetch_array($conn)){
		...
		$_7da43659dfebcaab2ad4bbd2f2a98f30=mysqli_query($conns,"select * from ujian where id_paket='".$_b78f9e7c4587e8583ab713f126277f88."' and id_siswa='".$_60169cd1c47b7a7a85ab44f884635e41['id_siswa']."' and selesai='Y'");

...
$conn=mysqli_query($conns,"select count(*) as jml from pelajaran where (kode like '%".$sqlgetsoal."%' or nama like '%".$sqlgetsoal."%') ");
...
$tables='';
$conn="select * from pelajaran where (kode like '%".$sqlgetsoal."%' or nama like '%".$sqlgetsoal."%') order by nama limit ".$nilaiujiansoals.",".$nilaiujiansoal;

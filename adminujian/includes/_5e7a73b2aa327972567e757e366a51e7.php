...
if(isset($_POST['save'])){
	...
	if(empty($_f77c5a659797b862f0fc544aa9a0c023) or empty($_31985b26056f955fec6db8f46f87653f)){
		...
		if($_d35a39212fd75e833aea38f90831b2cb=='add'){
			if(mysqli_num_rows(mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"select * from kelas where kode='".$_f77c5a659797b862f0fc544aa9a0c023."'"))>0){
				$_b5adde8d7d7412251f47419fe9bf51a7='Kode sudah terdaftar. Silahkan daftarkan kode yang lain.';
			}else{
				$_eb6af5b4e510c3c874d7d1f51d72393a="insert into kelas(kode, nama) values('".$_f77c5a659797b862f0fc544aa9a0c023."', '".$_31985b26056f955fec6db8f46f87653f."')";
		...
		if($_d35a39212fd75e833aea38f90831b2cb=='edit'){
			$_eb6af5b4e510c3c874d7d1f51d72393a=mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"select * from kelas where id_kelas='".$_3584859062ea9ecfb39b93bfcef8e869."'");
			...
			if(mysqli_num_rows(mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"select * from kelas where kode='".$_f77c5a659797b862f0fc544aa9a0c023."' and kode<>'".$_08fdfd209a120f38f85507412165a4ef."'"))>0){
				$_b5adde8d7d7412251f47419fe9bf51a7='Kode sudah terdaftar. Silahkan daftarkan kode yang lain.';
			}else{
				$_eb6af5b4e510c3c874d7d1f51d72393a="update kelas set kode='".$_f77c5a659797b862f0fc544aa9a0c023."',nama='".$_31985b26056f955fec6db8f46f87653f."' where id_kelas='".$_3584859062ea9ecfb39b93bfcef8e869."'";
				mysqli_query($_000b935637cea64cc7810fb0077f5ff1,$_eb6af5b4e510c3c874d7d1f51d72393a);
				exit("<script>location.href='".$pengumuman1."';</script>");
			}
		}
	...
	if($_d35a39212fd75e833aea38f90831b2cb=='delete'){
		$_3584859062ea9ecfb39b93bfcef8e869=$_GET['id'];
		mysqli_query($_000b935637cea64cc7810fb0077f5ff1,"delete from kelas where id_kelas='".$_3584859062ea9ecfb39b93bfcef8e869."'");
		exit("<script>location.href='".$pengumuman1."';</script>");
	}
}
